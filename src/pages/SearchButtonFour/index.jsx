  ...
  return (
    <>
      <div className="bg-white-A700 flex font-quicksand h-[2712px] justify-end mx-auto relative w-full">
        ...
        <div className="absolute bg-blue_gray-900_93 bottom-[0] flex flex-col inset-x-[0] items-center justify-start mx-auto pb-[291px] md:px-10 sm:px-5 px-[291px] w-full">
          <div className="bg-white-A700 flex flex-col items-center justify-start mb-[1882px] p-[93px] md:px-5 rounded-lg w-[97%] md:w-full">
            <div className="h-[230px] relative w-[52%]">
              <Img
                className="absolute h-[230px] inset-y-[0] left-[11%] my-auto object-cover w-[230px]"
                src="images/img_searchicon.png"
                alt="searchicon_One"
              />
              <Text
                className="absolute bottom-[5%] inset-x-[0] mx-auto text-blue_gray-100 text-lg w-max"
                size="txtQuicksandBold18"
              >
...
export default SearchButtonFourPage;
