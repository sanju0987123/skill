      ...
      <div className="bg-white-A700 flex flex-col font-quicksand items-center justify-start mx-auto w-full">
        <div className="flex flex-col items-center justify-start w-full">
          ...
          <Img
            ...
            alt="lineTwentyEight"
          />
          <div className="flex sm:flex-col flex-row sm:gap-10 items-center justify-between max-w-[1403px] mt-8 mx-auto md:px-5 w-full">
            <Img
          ...
          <div className="flex sm:flex-col flex-row sm:gap-10 items-center justify-between max-w-[1402px] mt-[39px] mx-auto md:px-5 w-full">
            <Img
              className="h-[199px] md:h-auto object-cover"
