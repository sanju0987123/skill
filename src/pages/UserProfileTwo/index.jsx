          ...
          <div className="flex flex-col md:px-5 relative w-full">
            ...
            <div className="flex flex-col gap-[19px] items-start justify-start ml-auto mr-[87px] mt-[-NaNpx] w-[73%] z-[1]">
              <div className="flex sm:flex-col flex-row sm:gap-5 items-start justify-start w-[45%] md:w-full">
                ...
                <Button
                  className="cursor-pointer font-quicksand font-semibold leading-[normal] mb-[9px] min-w-[88px] ml-2 sm:ml-[0] sm:mt-0 mt-5 text-center text-lg"
                  shape="round"
                  color="gray_900"
                  size="sm"
                  variant="fill"
...
export default UserProfileTwoPage;
