    ...
    <>
      <div className="bg-white-A700 flex flex-col font-quicksand items-center justify-start mx-auto w-full">
        <div className="flex flex-col items-center justify-start w-full">
          ...
          <div className="h-[198px] md:h-[216px] max-w-[1412px] mt-[18px] mx-auto md:px-5 relative w-full">
            <div className="absolute bg-gradient1  flex flex-col h-full inset-[0] items-start justify-center m-auto p-2 rounded-tl-[10px] rounded-tr-[10px] w-full">
              <div className="flex flex-col gap-7 justify-start ml-11 md:ml-[0] mt-[38px] w-[67%] md:w-full">
                ...
                >
                  <>
                    ...
                    <br />
                    <br />
                    Collaborate and bring your skills together! You can rent
                    additional designers and developers to strengthen your team
                  </>
                </Text>
                <Img
                  ...
                  alt="ellipse"
                  onClick={() => navigate("/homepagefour")}
                />
              </div>
            </div>
            <Img
              className="absolute h-[198px] inset-y-[0] my-auto object-cover right-[0] w-[36%]"
