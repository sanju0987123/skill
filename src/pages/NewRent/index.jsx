  ...
  useEffect(() => {
    ...
    islogin(); // Call the function when component mounts
      ...
      const filterOptions = (value) => {
        ...
        setFilteredOptions(...filteredOptions,filtered);
        ...
        try {
          ...
          if (filteredOptions.includes(formData.youneeda)) {
            ...
            const response = await database.createDocument(
              ...
              process.env.REACT_APP_COLLECTION_ID_SIX, // Collection ID for rentform
...
text-white-A700">You are Renting  Them for your work </h3>
...
onChange={handleChange}>
                            ...
                            <option value="1 month-15days">1-15days</option>
...
provide  this *</div>
                        ...
                        type="text"
                        id="Icanprovidethis"
                        name="Icanprovidethis"
                        value={formData.Icanprovidethis}
                        onChange={handleChange}
                        className="w-full rounded-lg py-2 px-4"
                        placeholder="Search for a role..."
                        list="roleOptions1"
                      />
                     <datalist id="roleOptions1">
                <option value="" disabled hidden>
                  Select a role...
                </option>
                {renderRoleOptions()}
...
povide service for  *</div>
                        <div className="rounded-full overflow-hidden w-[100%] ">
                          <select className="w-[100%] rounded-full py-2
px-4 pr-8" name="Icanpovideservicefor" value={formData.Icanpovideservicefor}
onChange={handleChange}>
                            <option value="">Select</option>
