    ...
    <>
      <div className="bg-white-A700 flex font-quicksand h-[2712px] justify-end mx-auto relative w-full">
        ...
        <div className="absolute bg-blue_gray-900_93 bottom-[0] flex flex-col font-ramaraja inset-x-[0] items-center justify-start mx-auto pb-[291px] md:px-10 sm:px-5 px-[291px] w-full">
          <div className="bg-white-A700 flex flex-col mb-[1882px] md:px-5 py-[25px] relative rounded-lg w-[97%] md:w-full">
            <div className="bg-gray-900 flex sm:flex-col flex-row gap-[22px] items-start justify-start mx-auto p-1 w-full">
            ...
            <List
              className="flex flex-col gap-3 mb-2.5 ml-5 mt-[-NaNpx] w-1/2 z-[1]"
            ...
            <div className="flex flex-col font-quicksand gap-[49px] items-center justify-start mb-[19px] ml-auto mr-7 mt-[-36.07px] z-[1]">
              <Text
...
export default SearchButtonOnePage;
