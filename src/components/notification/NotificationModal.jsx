...
const NotificationModal = ({ show, handleClose, requester, payscale,
...
'10px', right: '10px', cursor: 'pointer' }} />
      ...
      <Modal.Body className="text-center">
        <Modal.Title className="modal-heading">You have a request from
<strong>{requester}</strong> for hiring.</Modal.Title>
        <p>Hiring you as: {additionalInfo}</p>
